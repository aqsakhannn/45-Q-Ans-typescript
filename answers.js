...
let famous_person_message = '“A person who never made a mistake never tried anything new.”';
...
const withoutWhitespace = personName.trim();
...
let fullName = 'Aqsa Khan'; //My fullname is aqsa khan
let age = 29; //My age is 29.
//11. Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.
let friendsName = ['Maryum', 'Honey', 'Hurram'];
...
let transportation = ['Pijaro', 'Civic', 'Aulto'];
...
let guestList = ["Imran Khan", "Shehzad Waseem", "Sher Afzal khan"];
...
// in your list.
let absentGuest = "Shehzad Waseem";
console.log(absentGuest + " can't come to dinner.");
let newguest = "Kamran Khan Tessori";
...
let favPlaces = ["Makkah Madina", "Maldive", "New zee Land", "Canada", "Fairy Meadow"];
...
let Countries = ["Pakistan", "Canada", "China", "Japan", "India"];
console.log("List Of Countries");
console.log(Countries);
//21. They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
let student = { name: "Ahmed", rollno: 20, subject: "Maths", isPass: true };
...
let favFruits = ["Mangoe", "Grapes", "Dates", "Pomegranate", "Orange"];
...
let userName = ["Aqsa", "Hurram", "Maryum", "Admin"];
...
let currentUsers = ["Asra", "Aqsa", "Hurram", "Khizra", "Nosheen"];
let newUsers = ["Ahmed", "Aqsa", "Hurram", "Khizar", "Owais"];
...
// I really love pizza!
let favPizzas = ["Barbeque", "Fajita", "White sause"];
...
// message.
function makeShhirt(size = "large", message = ' I love Typescript.') {
    console.log(size + message);
}
makeShhirt();
makeShhirt("medium");
...
let magicians = ["Farhan", "Hurram", "Humza", "Nabiha"];
